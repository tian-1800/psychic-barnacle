...
const StockCard = ({ data, getStockData }: StockCardProps) => {
  const isPositive = parseFloat(data["09. change"]) >= 0;
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-sm">Latest Trading Day: {data["07. latest trading day"]}</p>
          </div>
          <div className="flex items-center space-x-2">
            <button
              onClick={() => getStockData(data["01. symbol"])}
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <p className="text-xl font-bold text-gray-900">{formatNumber(data["02. open"])}</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <p className="text-xl font-bold text-gray-900">${formatNumber(data["03. high"])}</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <p className="text-xl font-bold text-gray-900">${formatNumber(data["04. low"])}</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <p className="text-xl font-bold text-gray-900">{formatVolume(data["06. volume"])}</p>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-xl">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xl font-bold text-gray-900">${formatNumber(data["08. previous close"])}</span>
          </div>
        </div>
      </div>
    </div>
